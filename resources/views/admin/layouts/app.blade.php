...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false }">
    ...
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-gray-900 text-white flex flex-col shrink-0 transform transition-transform duration-200
        ...
        <main class="flex-1 min-w-0 overflow-auto">
            <!-- Mobile top bar -->
            <div class="sticky top-0 z-20 bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 lg:hidden">
                <button @click="sidebarOpen = true" class="text-gray-600 hover:text-gray-900 p-1">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/>
                    </svg>
                </button>
                <span class="text-sm font-semibold text-gray-700">⛅ App MeteOrihuela</span>
            </div>
